...
import { Button, Flex, Text, Image } from 'floki-uikit'
...
import { CenterCard, CardGroup, ImageCard } from '../style'
...
export default function RemoveLiquidity({
  ...
  const getActiveStyle = (val) => {
    return {
      color: formattedAmounts[Field.LIQUIDITY_PERCENT] === val ? '#7F4A0C' : '#DBAA5B',
      backgroundColor: formattedAmounts[Field.LIQUIDITY_PERCENT] === val ? '#DBAA5B' : '#ECC983',
    }
  }
  ...
  return (
    <Container>
      <CenterCard>
        <ImageCard>
          <Image src="images/img_rabbit_bunnies.png" width={120} height={120} mr="16px" />
        </ImageCard>
        <CardGroup>
          <AppBody>
                  ...
                  <OutlineCard>
                    <AutoColumn>
                      ...
                      <Flex justifyContent="center">
                        <Text fontSize="36px">{formattedAmounts[Field.LIQUIDITY_PERCENT]}%</Text>
                      </Flex>
                      {!showDetailed && (
                        <>
                          <Flex mb="8px">
          ...
          {pair ? (
            <AutoColumn style={{ minWidth: '436px', marginTop: '1rem' }}>
